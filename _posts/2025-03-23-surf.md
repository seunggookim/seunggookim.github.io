...
In neuroimaging community, this has been standardized as known as NIfTI ([Neuroimaging Informatics Technology Initiative](https://nifti.nimh.nih.gov/)). More general 3D computer graphics community uses formats such as VTK ([Visualization Toolkit](https://vtk.org)) and ITK ([Insight Toolkit](https://itk.org)).
