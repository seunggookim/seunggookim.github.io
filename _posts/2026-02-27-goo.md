...
**Problem**: I am trying to organise a teaching club at our institute. The problem is: some postdocs want to teach some topics, some PhD students want to learn other topics, and not everyone can come to the session every month. Now, how do we organise the schedule of sessions and assign instructors to topics to maximise the happiness of the whole community?

One might say that this is a simple combinatorial optimisation problem, and we can solve it with a simple greedy algorithm (e.g., _"okay let's first put the most popular topic first, and then..."_). But where's the fun in that?
