...
*UPDATED on 2024-09-16:* I've got more story on this now! This script worked fine on the local computer, but it doesn't build and deploy the web site on the remote🙃. So I learned more about how to find error messages from the deployment process built in the workflows; and learned that all JSON files in the directory should be valid. So I made the place-holder as a valid element: `"<ADD_HERE>": "summary"`.
So I learned a hard lesson that I must obey the JSON format, all the time...
