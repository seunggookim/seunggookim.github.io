...
My goal is to bring all of these together and make a contribution to **the Computational Theory of Human Emotion using Music as a Model System**. To have a science, we need reliability, consistency, and validity. How can we improve on these? 🤨

Self-reports of emotions can be seen as item responses. So item response theories may give ideas on the discrepancy between the experienced emotion and the self-reported responses. But what about the experience itself? How can we quantify one's subjective experience objectively?

**Reliability.** How do we address the weak causation between `events` that evoke emotions and `evoked emotions`?
Is this a common characteristics of `all feelings` like pain and hunger? Or is this specific to emotions? Is this purely random? Can we find a static probability distribution of evoked emotions?
