...
For the niche position of the major (Music Technology) and the course (Music [Neuro-]Science), the number of students were 2 to 6, which made one-on-one discussion on students' progress feasble.
...
The first semester [[2022WS]](MEM_2022WS_syllabus_v20230114.pdf) was constructed as a typical seminar course where students take turn to present research papers leading discussion with others.
Then I felt most of information delivered in lectures was irrelevant to most of six students.
Thus, in the next sememster [[2023SS]](MEM_2023SS_syllabus_v2023-06-04.pdf), I made it very relevant to students by setting a goal to design, implmenet, run, analyze, and write their own study. 
This change made four students widthdraw from the course.

Learned from this year, in next year, I started early. 
In the first semester [[2023WS]](MEM_2023WS_syllabus_v2023-10-25.pdf), three students focused on developing study idea, design, and implementing an online survey/experimet. Then, only two students were able to submit the term paper in the second semester [[2024SS]](MEM_2024SS_syllabus-2024-06-10). 
...
This, however, is extremely difficult to tell without a proper causal inference.
...
- [2024 Spring-Summer Semester: Empirical Methods for Music Research—Part 2](MEM_2024SS_syllabus-2024-06-10.pdf)


## Lecture Materials
- [Open Science Framework project](https://osf.io/rd243/)
